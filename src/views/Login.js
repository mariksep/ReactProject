      ...
      >
        ...
        >
          <Typography
            ...
            variant='h1'>NEIGHBOR HELP
          </Typography>
          <Typography variant='subtitle1' >
          Welcome to the neighbor help app. The neighbor help app helps you
          find help for everyday tasks and you can also offer it to others
          who need help </Typography>
        </Grid>
        <Grid
          ...
          <FormGroup>
            <Typography component='div'>
              <Grid component='label' container justify='center' alignItems='center' spacing={1}>
                ...
                <Switch color="default" onChange={showForms}
                  name="checkedA" />
                <Grid item> Ragister</Grid>
              </Grid>
            </Typography>
